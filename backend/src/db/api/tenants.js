...
module.exports = class TenantsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.users_tenant = await tenants.getUsers_tenant({
      transaction,
    });

    output.exhibitions_tenant = await tenants.getExhibitions_tenant({
      transaction,
    });

    output.messages_tenant = await tenants.getMessages_tenant({
      transaction,
    });

    output.pages_tenant = await tenants.getPages_tenant({
      transaction,
    });

    output.portfolios_tenant = await tenants.getPortfolios_tenant({
      transaction,
    });

    output.profiles_tenant = await tenants.getProfiles_tenant({
      transaction,
    });

    output.settings_tenant = await tenants.getSettings_tenant({
      transaction,
    });
