      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <div className={'mb-4'}>
            ...
            <p>{exhibitions?.gallery}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>Credits</p>
            <p>{exhibitions?.credits || 'No data'}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>Profile</p>

            <p>{exhibitions?.profile?.name ?? 'No data'}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>tenant</p>

            <p>{exhibitions?.tenant?.name ?? 'No data'}</p>
          </div>
