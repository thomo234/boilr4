...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/pages/pagesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configurePagesCols';
...
const TableSamplePages = ({
  ...
  useEffect(() => {
    if (pagesNotify.showNotification) {
      notify(pagesNotify.typeNotification, pagesNotify.textNotification);
    }
  }, [pagesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/pages/pages-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {pages && Array.isArray(pages) && !showGrid && (
        <ListPages
          pages={pages}
          loading={loading}
...
export default TableSamplePages;
