...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/profiles/profilesSlice';
...
const TableSampleProfiles = ({
  ...
  const handleViewAction = (id: string) => {
    router.push(`/profiles/profiles-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {profiles && Array.isArray(profiles) && !showGrid && (
        <ListProfiles
          profiles={profiles}
          loading={loading}
